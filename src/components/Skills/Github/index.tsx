  ...
  return (
    <div className="text-center py-12 px-4 sm:px-8">
      ...
      <div className="flex justify-center overflow-x-auto">
        <div className="bg-white rounded-2xl p-4 sm:p-8 shadow-2xl border border-gray-100 inline-block">
          <div className="calendar-wrapper text-gray-700">
            {isClient ? (
              <GitHubCalendar
                ...
                // Reduce data for better performance
                year={new Date().getFullYear()}
                // Or show only last 6 months
